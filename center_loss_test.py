...
modelcheckpoint = keras.callbacks.ModelCheckpoint(
        '/home/wdxia/network_test/model_trained/denseNet_result/denseNet_GRG_3852_centerloss_128and0.5_{epoch:02d}-{val_loss:.3f}.hdf5',
        monitor='val_loss', verbose=0, save_best_only=True,
        save_weights_only=False, mode='auto', period=10)

csv_logger = keras.callbacks.CSVLogger('/home/wdxia/network_test/model_trained/denseNet_result/denseNet_GRG_3852_centerloss_128and0.5_training.log')
...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        #plt.show()
        savefig("/home/wdxia/network_test/model_trained/denseNet_result/FVdenseNet_GRG_3852_centerloss_128and0.5_loss.jpg")
...
# model.fit_generator(
#     train_generator,
#     steps_per_epoch=25734 // 128 + 1,  # 训练图像数/batch_size 3180 3180 // 128
#     epochs=50,
#    )  # 只用训练数据训练，这一步可以省掉试一下
...
model.fit_generator(
    get_batch_input(train_generator, 128),
    steps_per_epoch=50866 // 128,  # 25734 // 128 + 1,  # 训练图像数/batch_size 3180 3180 // 128
    epochs=epochs,
    callbacks=[modelcheckpoint, csv_logger, loss_history], # , csv_logger, loss_history
    validation_data=get_batch_input(validation_generator, 128),
    validation_steps=15144 // 128)  # 7972 // 128 + 1)  # 测试图像数/batch_size 636  636 // 128
