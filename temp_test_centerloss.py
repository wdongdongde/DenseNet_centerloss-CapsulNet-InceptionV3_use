...
if USE_MODEL:
    ...
    model.compile(optimizer='adam', loss=['sparse_categorical_crossentropy', lambda y_true, y_pred: y_pred], loss_weights=[1., lambda_c], metrics=['accuracy'])
...
modelcheckpoint = keras.callbacks.ModelCheckpoint(
        '/home/wdxia/network_test/model_trained/denseNet_result/temp_test/denseNet_GRG_3852_centerloss_32_{epoch:02d}-{val_loss:.3f}.hdf5',
        monitor='val_loss', verbose=0, save_best_only=True,
        save_weights_only=True, mode='auto', period=10)

csv_logger = keras.callbacks.CSVLogger('/home/wdxia/network_test/model_trained/denseNet_result/temp_test/denseNet_GRG_3852_centerloss_32_training.log')
...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        #plt.show()
        savefig("/home/wdxia/network_test/model_trained/denseNet_result/temp_test/FVdenseNet_GRG_3852_centerloss_32_loss.jpg")
...
model.fit_generator(
    get_batch_input(train_generator, 32),
    steps_per_epoch=50866 // 32,  # 25734 // 32 + 1,  # 训练图像数/batch_size 3180 3180 // 32
    epochs=epochs,
    callbacks=[modelcheckpoint, csv_logger, loss_history], # , csv_logger, loss_history
    validation_data=get_batch_input(validation_generator, 32),
    validation_steps=15144 // 32)  # 7972 // 32 + 1)  # 测试图像数/batch_size 636  636 // 32
