...
modelcheckpoint = keras.callbacks.ModelCheckpoint(
        '/home/wdxia/network_test/model_trained/denseNet_result/denseNet_NoneW_{epoch:02d}-{val_loss:.3f}.hdf5',
        monitor='val_loss', verbose=0, save_best_only=True,
        save_weights_only=False, mode='auto', period=10)

csv_logger = keras.callbacks.CSVLogger('/home/wdxia/network_test/model_trained/denseNet_result/denseNet_NoneW_training.log')
...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        #plt.show()
        savefig("/home/wdxia/network_test/model_trained/denseNet_result/FVdenseNet_gray_loss.jpg")
